While it is beyond the scope of this user-manual to expose the whole mechanics behind the code and most specifically [`TempLat`](https://github.com/cosmolattice/templat) and its [symbolic vocabulary](https://cosmolattice.github.io/templat/vocabulary.html) — the lattice library that forms the backbone of CosmoLattice — we want to elaborate on the main concept behind the implementation of the fields and their related algebra: ***Expression Templates***.
