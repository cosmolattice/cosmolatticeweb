# How to cite $\mathcal{C}\mathtt{osmo}\mathcal{L}\mathtt{attice}$
...
<div class="cl-cite" data-cl-cite>
  ...
  <section class="cl-cite__pane is-active" role="tabpanel" data-pane="read">
    <p class="cl-cite__quote">In this work we use <span class="cl-cite__logo">
      \(\mathcal{C}\mathtt{osmo}\mathcal{L}\mathtt{attice},\)
    </span>based on the lattice-cosmology techniques presented in <span class="cl-cite__refs">The&nbsp;Art&nbsp;I&nbsp;&amp;&nbsp;II</span>.</p>
